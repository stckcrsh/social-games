import type { ItemDef, ShopOffer, PlayerInventory, TradeOffer } from '../types/api';

const API_BASE = (import.meta as { env: { VITE_API_BASE_URL?: string } }).env.VITE_API_BASE_URL ?? 'http://localhost:3000';
